...
### **Calix Axos Router Shell 2**
**Calix Axos Router Shell 2** shell provides you with connectivity and management capabilities such as device structure discovery and power management for the resource. 

For more information on the device, see the vendor's official product documentation.

### Standard version
**Calix Axos Router Shell 2** is based on the Networking Shell Standard version **5.0.4**.
...
Release: **Calix Axos Router Shell 2**
...
#### **Calix Axos Router Shell 2 Attributes**
...
The **Calix Axos Router Shell 2** shell is available from the [Quali Community Integrations](https://community.quali.com/integrations) page. 
...
|:---|:---|
|CalixAxosRouterShell2.zip|Device shell package|
|Calix_Axos_Router_Shell_2_offline_dependencies.zip|Shell Python dependencies (for offline deployments only)|

# Importing and Configuring the Shell
This section describes how to import the **Calix Axos Router Shell 2** shell and configure and modify the shell’s devices.
...
1. Download the *Calix_Axos_Router_Shell_2_offline_dependencies.zip* file, see [Downloading the Shell](#downloading-the-shell).
...
**To create a resource for the device:**
  ...
  2. From the list, select **Calix Axos Router Shell 2**.
...
For release updates, see the shell's [GitHub releases page](https://github.com/QualiSystems/CalixAxosRouterShell2/releases).
